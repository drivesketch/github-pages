...
1. Click **Pages**, in the "GitHub Pages" section, use the Source drop-down, then select **Deploy from a branch**.
1. Select **main branch** in the Branch drop-down, then click Save.
